...
if (!user) {
return m.reply("☂︎ El usuario no se encuentra en mi base de datos. ☂︎");
}
...
`Estás a punto de eliminar *TODOS* los datos del usuario @${target.split('@')[0]}.\n\n` +
...
await conn.reply(m.chat, `*♫︎ ¡Datos de Usuario Restablecidos! ♫︎*\n\n` +
`Todos los datos de @${target.split('@')[0]} han sido eliminados.`, m, { mentions: [target] });
};
